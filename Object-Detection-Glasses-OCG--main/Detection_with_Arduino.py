...
def output(frame):
    ...
    if Device_Connected == True:
        ...
        cv2.putText(frame, status_text, (10, 200), cv2.FONT_HERSHEY_SIMPLEX, 1, color_ActionStatus, 2)
...
def Result(cap):
    while True:
        ...
        #confirmation_received = False  # Replace some_condition with your actual condition
    cap.release()
